...
;; The length of encode is 80 in Huffman tree code, if encoded in fixed-length
;; code, we need assign 3 bits for every symbol because 2^3 = 8, then the
;; length of message is 33x3 = 99.
